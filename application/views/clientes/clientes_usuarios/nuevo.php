...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Usuarios del Sistema Web</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
...
<section class="content">
    <div class="container-fluid">
        <div class="card card-primary">
            ...
            <h3 class="card-title">Usuarios del cliente</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->

            <form role="form" method="post" action="<?php echo base_url() ?>clientes/clientes_usuarios/guardar_post/<?php echo $datos['clienteid']; ?>" >
                <div class="card-body">
                    <!-- text input -->
                ...
                <div class="card-footer">
                    ...
                    <a class="btn btn-danger" href="<?php echo base_url() ?>clientes/clientes_usuarios"><i class="fa fa-undo"></i> Cancelar </a>
                </div>
            </form>
