    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="<?= base_url('acciones/accionesBycontrolador')."/".$datos->menuid ?>">Controladores</a></li>
          -->
        ...
        <div class="card card-primary">
            ...
            <form role="form" method="post" action="<?php echo base_url() ?>acciones/guardar_post/<?php echo $datos->accionid; ?>" >
                ...
                <div class="card-footer">
                    ...
                    <a class="btn btn-danger" href="<?= base_url('acciones/ControladorByMenu')."/".$datos->controladorid ?>"><i class="fa fa-undo"></i> Cancelar </a>
                </div>
            </form>
