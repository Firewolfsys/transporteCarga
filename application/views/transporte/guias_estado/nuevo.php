...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Estado de Guias del Sistema</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="<?= base_url('') ?>">Home</a></li>
          <li class="breadcrumb-item"><a href="<?= base_url('transporte/guias_estado') ?>">Estado Guias</a></li>
          <li class="breadcrumb-item active">Guardar Estado Guia</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
...
<section class="content">
    <div class="container-fluid">
        <div class="card card-primary">
            ...
            <h3 class="card-title">Estados de Guia</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->

            <form role="form" method="post" action="<?php echo base_url() ?>transporte/guias_estado/guardar_post/<?php echo $datos['id_guias_estado']; ?>" >
                <div class="card-body">
                    <!-- text input -->
