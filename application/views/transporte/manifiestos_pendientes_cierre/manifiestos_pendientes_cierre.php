...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Manifiestos Pendientes de cierre</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="<?= base_url('') ?>">Home</a></li>
          <li class="breadcrumb-item active">Cierre de Manifiestos</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
    ...
    <div class="col-12">
      <div class="card card-primary">
        <div class="card-header">
          <h3 class="card-title">Manifiestos Pendientes de cierre</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          <br>
              ...
              <tbody>
                <?php foreach($datos as $item): ?>
                  <tr>
                    ...
                    <td width="5%">
                      <div class="btn-group" >
                        <a class="btn btn-primary" title="Finalizar Manifiesto" href="<?php echo base_url() ?>transporte/manifiestos_pendientes_cierre/finalizar/<?php echo $item->id_manifiesto ?>"> <i class="fa fa-check"></i> </a>
                      </div>
                    </td>
                  </tr>
                <?php endforeach; ?>
