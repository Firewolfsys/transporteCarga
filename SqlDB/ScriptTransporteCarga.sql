...
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=latin1 COMMENT='controladores del sistema';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `menus` (
  ...
  `orden` int(11) NOT NULL,
  PRIMARY KEY (`MenuID`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1 COMMENT='Menus del sistema';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `menus` VALUES (1,'Administracion','fa-cogs',1),(2,'Clientes','fa-users',3),(3,'Transporte','fa-truck',3),(6,'Facturacion','fa-calculator',2),(7,'Catalogos Basicos','fa-info',1),(8,'Reportes','fa-file-text',5);
...
-- Dump completed on 2018-08-31 17:39:13
