...
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=latin1 COMMENT='controladores del sistema';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `controladores` VALUES (1,'Usuarios Admin',1,'admin/usuario_admin',4),(2,'Usuarios Web',1,'admin/usuario_web',5),(3,'Clientes',2,'clientes/clientes',0),(4,'Origenes y Destinos',3,'transporte/lugares',0),(6,'Guias',3,'transporte/guias',0),(7,'Tipos de Documentos',6,'facturacion/tipo_doctos',1),(8,'Menus',1,'admin/menus',1),(9,'Roles',1,'admin/roles',3),(12,'Tipos Pago',6,'facturacion/tipos_pago',2),(14,'servicios',3,'transporte/servicios',3),(17,'Unidades de Medida',7,'transporte/unidad_medida',1),(18,'Tipo Servicio',7,'transporte/tipo_servicio',2),(19,'Estado Piloto',7,'transporte/estados_piloto',3),(20,'Estado Guias',7,'transporte/guias_estado',4),(21,'Creación de manifiestos',3,'transporte/manifiestos',3),(22,'Traslado de manifiestos',3,'transporte/manifiestos_traslado',4),(23,'Manifiestos por piloto',8,'transporte/manifiestos_reporte',1),(24,'Pilotos',9,'transporte/pilotos',1);
...
CREATE TABLE `menus` (
  ...
  `orden` int(11) NOT NULL,
  PRIMARY KEY (`MenuID`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=latin1 COMMENT='Menus del sistema';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `menus` VALUES (1,'Administracion','fa-cogs',1),(2,'Clientes','fa-users',3),(3,'Transporte','fa-truck',3),(6,'Facturacion','fa-calculator',2),(7,'Catalogos Basicos','fa-info',1),(8,'Reportes','fa-file-text',5),(9,'Control Pilotos','fa-users',3);
...
-- Dump completed on 2018-09-25 18:33:57
